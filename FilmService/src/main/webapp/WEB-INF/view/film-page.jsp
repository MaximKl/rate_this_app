...
<!DOCTYPE html>
    <head>
        <meta charset="utf-8">
        <title>Сторінка фільму - ${film.name}</title>
        ...
        <div id="main">
                <div style="display: flex; width:100%; height:100px; background-color:#027a32; text-align:center; position:fixed; top:0px; z-index:1;">
                    <div style="width:60%; margin-top:24px; text-align:center;">
                        <h1 style="display:inline; margin-top:200px; font-size:40px; color:white;">Сторінка фільму - ${film.name}</h1>
                    </div>
            ...
            <a style="user-select:none; font-size:120px; cursor:pointer; color:#505250; left:0; top:0; margin-left:100px; margin-top:80px; position:absolute; text-decoration: none;" href="http://localhost:9191/films">&larr;</a>
                    ...
                    <div style="margin-top:120px; padding-top:20px; background-color:#f7cc54; border-radius:30px;">
                        ...
                        <table>
                            <tr>
                                ...
                                <td class="gInfo">${film.name}</td>
                            </tr>
                            <tr>
                                <td class="names">Дата виходу:</td>
                                <td class="gInfo"> <fmt:formatDate value="${film.releaseDate}" pattern="dd.MM.yyyy" /></td>
                            </tr>
                            <tr>
                                <td class="names">Режисери:</td>
                                <td class="gInfo">
                                <c:forEach var="dir" items="${film.directors}">
                                    ${dir.name}&nbsp${dir.surname},&nbsp;
                                </c:forEach>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="gInfo">${film.studio.name}</td>
                            </tr>

                            <tr>
                                <td class="names">Видавець:</td>
                                <td class="gInfo">${film.publisher.name}</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="gInfo">${film.cost} $</td>
                            </tr>
                            <tr>
                                <td class="names">Тривалість:</td>
                                <td class="gInfo">${film.length} хвилин</td>
                            </tr>
                            <tr>
                                <td class="names">Країна створення:</td>
                                 <td class="gInfo">
                                <c:forEach var="country" items="${film.countries}">
                                    ${country.name},&nbsp;
                                </c:forEach>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="gInfo">${film.description}</td>
                            </tr>
                        </table>
                        <br>
                    </div>
                ...
                <div style="width:50%;">
                     <div id="scores" style="margin-top:120px; margin-right:50px; background-color:#5c97f7; border-radius:30px; display:none;">
                        ...
                        <table>
                            ...
                            <tr>
                                <td class="names" style="font-weight:bold;">Зйомка:</td>
                                <td style="font-weight:bold;">
                                <select style="width:190px; height:30px; text-align:center;" id="cameraMark">
                                  <c:forEach var="n" items="${numbers}">
                                      <option value="${n}">${n}</option>
                                  </c:forEach>
                                  <option value="-1" selected label="--не обрано--"></option>
                            ...
                            <tr>
                                <td class="names" style="font-weight:bold;">Актори:</td>
                                <td style="font-weight:bold;">
                                <select style="width:190px; height:30px; text-align:center;" id="actorsMark">
                                  <c:forEach var="n" items="${numbers}">
                                      <option value="${n}">${n}</option>
                                  </c:forEach>
                                  <option value="-1" selected label="--не обрано--"></option>
                      ...
                      <div id="regMessage" style="margin-top:120px; margin-right:50px; background-color:#5c97f7; border-radius:30px; display:none;">
                        <h2 style="text-align:center; padding:15px;">ЩОБ ОЦІНИТИ ФІЛЬМ, ПОТРІБНО ЗАРЕЄСТРУВАТИСЯ АБО УВІЙТИ!</h2>
                        <input id="regB"
                      ...
                      <div id="alreadyMessage" style="margin-top:120px; margin-right:50px; background-color:#5c97f7; border-radius:30px; display:none;" >
                        <h2 style="text-align:center; padding:15px;">ВИ ВЖЕ ОЦІНИЛИ ЦЕЙ ФІЛЬМ!</h2>
                        <h4 style="text-align:center; color:#2b1515; ">${wrong}</h4>
                        <input id="changeB"
                    ...
                    <div style="margin-top:30px; margin-right:50px; background-color:#4ff7ba; border-radius:30px;">
                        <h3 style="text-align:center; padding-top:30px; margin-top:20px;">Загально-середні оцінки на сайті</h3>
                            <table>
                                <tr>
                                    <td class="names" style="font-weight:bold;">Загальна оцінка:</td>
                                    <td style="font-weight:bold;">${film.commonMark}/100</td>
                                </tr>
                                <tr>
                                    <td class="names">Ефекти:</td>
                                    <td>${film.effectMark}/100</td>
                                </tr>
                                <tr>
                                    <td class="names">Історія:</td>
                                    <td>${film.storyMark}/100</td>
                                </tr>
                                <tr>
                                    <td class="names">Зйомка:</td>
                                    <td>${film.cameramanMark}/100</td>
                                </tr>
                                <tr>
                                    <td class="names">Актори:</td>
                                    <td>${film.actorsMark}/100</td>
                                </tr>
                                <tr>
                                    <td class="names">Звук:</td>
                                    <td>${film.soundMark}/100</td>
                                </tr>
                            </table>
                           <br>
                           <br>
            ...
            <br>
                <div style="margin-top:40px;">
                    ...
                    <div id="userComs" style="margin-top:40px; display:none;">
                        ...
                        <c:forEach var="coms1" items="${thisFilmComment}">
                    ...
                    <div style="margin-top:40px;">
                        ...
                        <c:forEach var="coms2" items="${filmComments}">
    ...
    <script>
        ...
        function load(){
          if(window.location.href=="http://localhost:9002/films/${id}"){
              window.location.replace("http://localhost:9191/films/${id}");
          }
       ...
       function exit() {
         ...
         function addScore(){
            ...
            var soundMark = buffer.options[buffer.selectedIndex].value;
                ...
                buffer = document.getElementById('cameraMark');
            var cameraMark = buffer.options[buffer.selectedIndex].value;

                buffer = document.getElementById('actorsMark');
            var actorsMark = buffer.options[buffer.selectedIndex].value;

            window.location.replace("http://localhost:9191/films/${id}?comM="+comMark+"&efM="+effectMark+"&stM="+storyMark+"&soundM="+soundMark+"&actM="+actorsMark+"&camM="+cameraMark+"&toChange="+toChangeMarks);
         }
