...
<!DOCTYPE html>
    <head>
        <meta charset="utf-8">
        <title>Рецензія на книгу - ${review.book.name}</title>
        ...
        <div id="main">
                <div style="display: flex; width:100%; height:100px; background-color:#027a32; text-align:center; position:fixed; top:0px; z-index:1;">
                    <div style="width:75%; margin-top:24px; text-align:center;">
                        <h1 style="display:inline; margin-top:200px; font-size:40px; color:white;">Рецензія на книгу - ${review.book.name}</h1>
                    </div>
            ...
            <div style="margin-top:120px; padding-top:20px; background-color:#f7cc54; border-radius:30px;">
                ...
                <table>
                    <tr>
                        ...
                        <td class="gInfo">${review.book.name}</td>
                    </tr>
                    <tr>
                        <td class="names">Актори:</td>
                        <td class="gInfo">
                        <c:forEach var="auth" items="${review.book.authors}">
                    ...
                    <tr>
                        <td class="names">Країна створення:</td>
                         <td class="gInfo">
                        <c:forEach var="country" items="${review.book.countries}">
                            ${country.name},&nbsp;
                        </c:forEach>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="gInfo">
                        <c:forEach var="category" items="${review.book.categories}">
                            ${category.name},&nbsp;
                        </c:forEach>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="gInfo">${review.book.description}</td>
                    </tr>
                </table>
            ...
            <div style="margin-top:50px; background-color:#4ff7ba; border-radius:30px;">
                <h3 style="text-align:center; padding-top:20px; margin-top:20px;">Загально-середні оцінки на сайті</h3>
                    <table>
                        <tr>
                            <td class="names" style="font-weight:bold;">Загальна оцінка:</td>
                            <td style="font-weight:bold;">${review.book.commonMark}/100</td>
                        </tr>
                        <tr>
                            <td class="names">Текст:</td>
                            <td>${review.book.artMark}/100</td>
                        </tr>
                        <tr>
                            <td class="names">Історія:</td>
                            <td>${review.book.storyMark}/100</td>
                        </tr>
                    </table>
                        <br>
                        <br>
    ...
    <script>
        ...
        function load(){
            if(window.location.href=="http://localhost:9003/profile/user/${name}/book/${id}"){
                window.location.replace("http://localhost:9191/profile/user/${name}/book/${id}");
            }
