...
<!DOCTYPE html>
    <head>
        <meta charset="utf-8">
        <title>Рецензія на гру - ${review.game.name}</title>
        ...
        <div id="main">
                <div style="display: flex; width:100%; height:100px; background-color:#027a32; text-align:center; position:fixed; top:0px; z-index:1;">
                    <div style="width:75%; margin-top:24px; text-align:center;">
                        <h1 style="display:inline; margin-top:200px; font-size:40px; color:white;">Рецензія на гру - ${review.game.name}</h1>
                    </div>
            ...
            <div style="margin-top:120px; padding-top:20px; background-color:#f7cc54; border-radius:30px;">
                ...
                <table>
                    <tr>
                        ...
                        <td class="gInfo">${review.game.name}</td>
                    </tr>
                    <tr>
                        <td class="names">Розробник:</td>
                        <td class="gInfo">
                        <c:forEach var="dev" items="${review.game.developers}">
                            ${dev.name},&nbsp;
                        </c:forEach>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="gInfo">${review.game.publisher.name}</td>
                    </tr>
                    <tr>
                        <td class="names">Бюджет:</td>
                        <td class="gInfo">${review.game.cost} $</td>
                    </tr>
                    <tr>
                        <td class="names">Дата релізу:</td>
                        <td class="gInfo"> <fmt:formatDate value="${review.game.releaseDate}" pattern="yyyy.MM.dd" /></td>
                    </tr>
                    <tr>
                        <td class="names">Країна створення:</td>
                         <td class="gInfo">
                        <c:forEach var="country" items="${review.game.countries}">
                            ${country.name},&nbsp;
                        </c:forEach>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="gInfo">
                        <c:forEach var="category" items="${review.game.categories}">
                            ${category.name},&nbsp;
                        </c:forEach>
                        </td>
                    </tr>
                    <tr>
                        <td class="names">Витрачений вами час:</td>
                        <td class="gInfo">${review.spentTime} годин</td>
                    </tr>
                    <tr>
                        <td class="names">Опис:</td>
                        <td class="gInfo">${review.game.description}</td>
                    </tr>
                </table>
            ...
            <div style="margin-top:50px; background-color:#4ff7ba; border-radius:30px;">
                <h3 style="text-align:center; padding-top:30px; margin-top:20px;">Загально-середні оцінки на сайті</h3>
                    <table>
                        <tr>
                            <td class="names" style="font-weight:bold;">Загальна оцінка:</td>
                            <td style="font-weight:bold;">${review.game.commonMark}/100</td>
                        </tr>
                        <tr>
                            <td class="names">Ефекти:</td>
                            <td>${review.game.effectMark}/100</td>
                        </tr>
                        <tr>
                            <td class="names">Історія:</td>
                            <td>${review.game.storyMark}/100</td>
                        </tr>
                        <tr>
                            <td class="names">Геймплей:</td>
                            <td>${review.game.gameplayMark}/100</td>
                        </tr>
                        <tr>
                            <td class="names">Ідея:</td>
                            <td>${review.game.ideaMark}/100</td>
                        </tr>
                        <tr>
                            <td class="names">Звук:</td>
                            <td>${review.game.soundMark}/100</td>
                        </tr>
                    </table>
                        <br>
                        <br>
    ...
    <script>
        ...
        function load(){
          if(window.location.href=="http://localhost:9003/profile/user/${name}/game/${id}"){
              window.location.replace("http://localhost:9191/profile/user/${name}/game/${id}");
          }
